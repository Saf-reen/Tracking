        ...
        <main className="flex items-center justify-center flex-1 px-4 py-12 sm:py-16">
          <Card className="w-full max-w-md p-6 mx-auto sm:p-8">
            <div className="text-center">
              ...
              <h2 className="mb-4 text-2xl font-bold text-gray-800">Password Reset Successful</h2>
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full px-4 py-3 font-semibold text-white transition-colors duration-200 bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                >
                  Continue to Sign In
                </button>
        ...
        <div className="w-full max-w-md">
          <Card className="w-full max-w-md p-6 mx-auto sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              />
              <div className="p-4 space-y-1 text-xs text-gray-600 bg-gray-50">
              ...
              <div className="flex justify-center pt-2">
                <button
                  ...
                  className="w-full px-4 py-3 text-lg font-semibold text-white transition-colors duration-200 bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50"
                >
